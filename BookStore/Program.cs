...
using BookStore.BL.BookProducerService;
...
namespace BookStore
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            builder.Services.AddSingleton<IAuthorRepository, AuthorRepositoryMongo>();
            builder.Services.AddSingleton<IAuthorService, AuthorService>();
            builder.Services.AddSingleton<ILibraryService, LibraryService>();
            builder.Services.AddScoped<IIdentityService, IdentityService>();
            builder.Services.AddSingleton<IBookProducerService, BookProducerService>();
            ...
            builder.Services.AddIdentity<IdentityUser, MongoIdentityRole>().AddMongoDbStores<IdentityUser, MongoIdentityRole, Guid>
